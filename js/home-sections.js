const HOME_SECTIONS = {
  photos: {
    ...
    title: "恋爱事记",
    subtitle: "整个世界森林里的老虎全都融化成黄油^>៸៸៸៸<^੭",
    countTemplate: "💕小林和小鱼一共记录了 {count} 条恋爱事记！",
    emptyMain: "还没有恋爱事记",
  ...
  foods: {
    ...
    title: "美食墙",
    subtitle: "爱就是要在一起吃好多好多美味៷>ᴗ<៷",
    countTemplate: "🍜小林和小鱼一起打卡了 {count} 家美食！",
    emptyMain: "还没有添加美食",
